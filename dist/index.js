...
var baseConvert = __webpack_require__(98),
...
var baseSetData = __webpack_require__(50),
    createBind = __webpack_require__(109),
    ...
    setData = __webpack_require__(61),
    setWrapToString = __webpack_require__(63),
 ...
 */
const swapTwoNodes = parent => (firstNode, secondNode) => {
    const afterFristNode = firstNode.nextElementSibling;
    const afterSecondNode = secondNode.nextElementSibling;

    parent.insertBefore(secondNode, afterFristNode);
    parent.insertBefore(firstNode, afterSecondNode);

    return parent;
};
/* harmony export (immutable) */ __webpack_exports__["e"] = swapTwoNodes;
...
module.exports = __webpack_require__.p + "monks.jpg";
...
var convert = __webpack_require__(8),
    func = convert('range', __webpack_require__(216));

func.placeholder = __webpack_require__(5);
module.exports = func;
...
var composeArgs = __webpack_require__(56),
    ...
    createRecurry = __webpack_require__(58),
    getHolder = __webpack_require__(66),
...
var getWrapDetails = __webpack_require__(118),
    insertWrapDetails = __webpack_require__(119),
    setToString = __webpack_require__(64),
    updateWrapDetails = __webpack_require__(122);
...
var convert = __webpack_require__(8),
    func = convert('shuffle', __webpack_require__(220), __webpack_require__(46));
...
var baseRandom = __webpack_require__(222);
...
var convert = __webpack_require__(8),
    func = convert('isEqual', __webpack_require__(227));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_fp_range__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_fp_range___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_fp_range__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_fp_shuffle__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_fp_shuffle___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash_fp_shuffle__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Puzzle__ = __webpack_require__(226);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_monks_jpg__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_monks_jpg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__assets_monks_jpg__);
...
const init = image => {
    ...
    const puzzle = new __WEBPACK_IMPORTED_MODULE_3__Puzzle__["a" /* default */](PUZZLE_SIZE, image, rootElement, 'tile');
...
var mapping = __webpack_require__(99),
    fallbackHolder = __webpack_require__(5);
...
var createWrap = __webpack_require__(23);
...
var LazyWrapper = __webpack_require__(26),
    getData = __webpack_require__(59),
    getFuncName = __webpack_require__(114),
    lodash = __webpack_require__(116);
...
var realNames = __webpack_require__(115);
...
var LazyWrapper = __webpack_require__(26),
    ...
    isArray = __webpack_require__(1),
    isObjectLike = __webpack_require__(3),
    wrapperClone = __webpack_require__(117);
...
var addSetEntry = __webpack_require__(180),
    arrayReduce = __webpack_require__(84),
...
var createWrap = __webpack_require__(23),
    flatRest = __webpack_require__(210);
...
var createRange = __webpack_require__(217);
...
var baseRange = __webpack_require__(218),
...
var arrayShuffle = __webpack_require__(221),
    baseShuffle = __webpack_require__(223),
    isArray = __webpack_require__(1);
...
var copyArray = __webpack_require__(9),
    shuffleSelf = __webpack_require__(95);
...
var shuffleSelf = __webpack_require__(95),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_fp_shuffle__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_fp_shuffle___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash_fp_shuffle__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_fp_isEqual__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_fp_isEqual___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash_fp_isEqual__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_fp_isFunction__ = __webpack_require__(228);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_fp_isFunction___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_lodash_fp_isFunction__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_fp_isElement__ = __webpack_require__(229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_fp_isElement___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash_fp_isElement__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helpers__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Tile__ = __webpack_require__(232);
...
class Puzzle {
    constructor(size, image, rootElement, tileClassName) {
        if (!size) throw new Error('Please provide the size of the puzzle.');
        if (!(image instanceof HTMLImageElement)) throw new Error('Please provide the image of the puzzle.');
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash_fp_isElement___default()(rootElement)) throw new Error('Please provide the element to render the puzzle.');
        ...
        this.callbacks = [];
        this.getTileCoordinates = Object(__WEBPACK_IMPORTED_MODULE_5__helpers__["b" /* getCoordinatesByPosition */])(this.size);
    ...
    buildTiles(range) {
        ...
        return range.map((expectedPosition, position) => {
    ...
    swap(tileToMove) {
        ...
        const newTiles = Object(__WEBPACK_IMPORTED_MODULE_5__helpers__["d" /* swapItemsInArray */])(this.state.tiles)(tileToMove, emptyTile);

        // Insread of re-rendeing the whole list, lets just swap the tiles!
        Object(__WEBPACK_IMPORTED_MODULE_5__helpers__["e" /* swapTwoNodes */])(this.rootElement)(emptyTile.render(), tileToMove.render());
    ...
    canTileMove(tile) {
        ...
        if (coordinates.x > 0) {
            coordinatesToCheck.push(_extends({}, coordinates, {
                x: coordinates.x - 1
            }));
        }
    ...
    getTileByCoordinates(coordinates) {
        return this.state.tiles.find(tile => __WEBPACK_IMPORTED_MODULE_2_lodash_fp_isEqual___default()(tile.getCurrentCoordinates(), coordinates));
    }
     ...
     */
    subscribe(callback) {
        __WEBPACK_IMPORTED_MODULE_3_lodash_fp_isFunction___default()(callback) && this.callbacks.push(callback);
    }
    ...
    render() {
        ...
        if (this.state.solved) {
            ...
            this.state.tiles.forEach(tile => fragment.appendChild(tile.render(this.tileClassName)), this);
...
var convert = __webpack_require__(8),
    func = convert('isFunction', __webpack_require__(13), __webpack_require__(46));
...
var convert = __webpack_require__(8),
    func = convert('isElement', __webpack_require__(230), __webpack_require__(46));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_fp_isEqual__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_fp_isEqual___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_fp_isEqual__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers__ = __webpack_require__(47);
...
class Tile {
    ...
    constructor(props) {
        ...
        const canvasElement = Object(__WEBPACK_IMPORTED_MODULE_1__helpers__["a" /* createDOMElement */])('canvas')({
     ...
     */
    drawImage(context) {
        context.drawImage(this.props.image, this.props.expectedCoordinates.x * this.props.width, this.props.expectedCoordinates.y * this.props.height, this.props.width, this.props.height, 0, 0, this.props.width, this.props.height);
    }
     ...
     */
    isAtTheRightPlace() {
        return this.isEmpty || __WEBPACK_IMPORTED_MODULE_0_lodash_fp_isEqual___default()(this.props.currentCoordinates, this.props.expectedCoordinates);
    }
